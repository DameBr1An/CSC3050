...
LENGTH: .word 13
.text
__builtin_memcpy_aligned_large:addi   $t7, $a2, -4
...
__builtin_memcpy_bytes:beq   $a2, $zero, __builtin_memcpy_return
	lbu   $t0, 0($a1)
	sb    $t0, 0($a0)
	addi  $a2, $a2, -1
...
__builtin_memcpy:
	...
	subu  $t1, $zero, $a0
	andi  $t1, $t1, 3
__builtin_memcpy_prepare:beq  $t1, $zero, __builtin_memcpy_check
	lbu   $t0, 0($a1)
	sb    $t0, 0($a0)
	addi  $a2, $a2, -1
